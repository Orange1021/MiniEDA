...
# Cell: NOR2_2
cell_rect = patches.Rectangle((0.57, 0), 0.57, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(0.855, 0.7, 'NOR2_2', ha='center', va='center', fontsize=8)
...
# Cell: OR2_1
cell_rect = patches.Rectangle((3.92228, 3), 0.76, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(4.30228, 3.7, 'OR2_1', ha='center', va='center', fontsize=8)
...
# Cell: G3
cell_rect = patches.Rectangle((5.13, 3), 3.16228, 3.16228, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(6.71114, 4.58114, 'G3', ha='center', va='center', fontsize=8)

# Cell: G2
cell_rect = patches.Rectangle((0.76, 0), 3.16228, 3.16228, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(2.34114, 1.58114, 'G2', ha='center', va='center', fontsize=8)
...
# Cell: DFF_2
cell_rect = patches.Rectangle((0.57, 0), 3.23, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(2.185, 0.7, 'DFF_2', ha='center', va='center', fontsize=8)

# Cell: G1
cell_rect = patches.Rectangle((0.76, 0), 3.16228, 3.16228, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(2.34114, 1.58114, 'G1', ha='center', va='center', fontsize=8)

# Cell: NOT_1
cell_rect = patches.Rectangle((6.08, 6), 0.38, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(6.27, 6.7, 'NOT_1', ha='center', va='center', fontsize=8)
...
ax.set_title('MiniPlacement - visualizations/20251130_211925_191/detailed.png')
ax.grid(True, alpha=0.3)

# Save the plot
plt.tight_layout()
plt.savefig('visualizations/20251130_211925_191/detailed.png', dpi=150, bbox_inches='tight')
plt.close()

print("Plot saved as: visualizations/20251130_211925_191/detailed.png")
