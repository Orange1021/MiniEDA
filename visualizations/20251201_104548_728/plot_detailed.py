...
# Cell: NOR2_1
cell_rect = patches.Rectangle((3.6896, 6), 0.57, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(3.9746, 6.7, 'NOR2_1', ha='center', va='center', fontsize=8)

# Cell: NOR2_0
cell_rect = patches.Rectangle((4.4496, 6), 0.57, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(4.7346, 6.7, 'NOR2_0', ha='center', va='center', fontsize=8)
...
# Cell: NOT_0
cell_rect = patches.Rectangle((3.3096, 4.10997), 0.38, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(3.4996, 4.80997, 'NOT_0', ha='center', va='center', fontsize=8)

# Cell: G0
cell_rect = patches.Rectangle((3.30949, 4.11007), 0.38, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(3.49949, 4.81007, 'G0', ha='center', va='center', fontsize=8)
...
# Cell: G17
cell_rect = patches.Rectangle((3.8, 4.11002), 0.38, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(3.99, 4.81002, 'G17', ha='center', va='center', fontsize=8)

# Cell: AND2_0
cell_rect = patches.Rectangle((3.6896, 6), 0.76, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(4.0696, 6.7, 'AND2_0', ha='center', va='center', fontsize=8)
...
# Cell: NOT_1
cell_rect = patches.Rectangle((3.68949, 4.11006), 0.38, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(3.87949, 4.81006, 'NOT_1', ha='center', va='center', fontsize=8)
...
ax.set_title('MiniPlacement - visualizations/20251201_104548_728/detailed.png')
ax.grid(True, alpha=0.3)

# Save the plot
plt.tight_layout()
plt.savefig('visualizations/20251201_104548_728/detailed.png', dpi=150, bbox_inches='tight')
plt.close()

print("Plot saved as: visualizations/20251201_104548_728/detailed.png")
