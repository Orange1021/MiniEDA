...
# Cell: START
cell_rect = patches.Rectangle((8.75414, 8.73207), 0.38, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(8.94414, 9.43207, 'START', ha='center', va='center', fontsize=8)
...
# Cell: DFF_4
cell_rect = patches.Rectangle((10.64, 9), 3.23, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(12.255, 9.7, 'DFF_4', ha='center', va='center', fontsize=8)
...
# Cell: DFF_12
cell_rect = patches.Rectangle((13.87, 9), 3.23, 1.4, linewidth=1, edgecolor='blue', facecolor='lightblue', alpha=0.7)
ax.add_patch(cell_rect)
ax.text(15.485, 9.7, 'DFF_12', ha='center', va='center', fontsize=8)
...
ax.set_title('MiniPlacement - visualizations/20251201_104600_360/legalized.png')
ax.grid(True, alpha=0.3)

# Save the plot
plt.tight_layout()
plt.savefig('visualizations/20251201_104600_360/legalized.png', dpi=150, bbox_inches='tight')
plt.close()

print("Plot saved as: visualizations/20251201_104600_360/legalized.png")
